...
def test_multi_file_instance_set_single_instance() -> None:
    ...
    paths = [Path("Examples/Resources/CCAG/Instances/CCAG/Banking1.model"),
...
def test_file_instance_set_single_file() -> None:
    ...
    assert single_instance_set.directory == Path(
...
def test_file_instance_set_directory() -> None:
    ...
    assert file_instance_set.get_path_by_name(
        "Ptn-7824-b01") == next((p for p in dir_content
                                 if p.stem == "Ptn-7824-b01"), None)

...
if __name__ == r'__main__':
	...
	if len(sys.argv) != 7 and len(sys.argv) != 9:
		print('Usage: %s <data_solver_configured_vs_default_filename> <penalty_time> <default_name> <configured_name> <figure_solver_configured_vs_default_filename> <performance_measure>' % (sys.argv[0]))
		exit(-1)
	...
	# Only plot cutoff boundaries for PAR10, they are not meaningful for QUALITY performance
	if performance_measure == 'PAR10':
		# Cutoff time x axis

...
# The scenario directory is named after the solvers that remain after marginal-contribution filtering, so resolve the generated path instead of assuming a fixed solver combination.

...
def print_command(instance_file, seed_str: str, cutoff_time_str: str):
    ...
    param_str = ("-opt '0' -print_sol '1' -edge_weight_p_scale '0.5214052710418935' "
                 ...
                 "-perform_adding_random_walk '0' -perform_bms '0' "
                 "-perform_cc_adding '1' -perform_edge_weight_scheme '1' "
                 "-perform_preprocess '1' -perform_removing_random_walk '0' "
                 "-perform_ruin_and_reconstruct '0' -sel_adding_v '4' "
                 "-sel_edge_weight_scheme '1' -sel_removing_v '2' -sel_uncov_e '1' "
                 "-tabu_tenure '5'")

...
class Settings:
    ...
    OPTION_solver_cutoff_time = Option(
        "solver_cutoff_time", SECTION_general, int, None,
    ...
    OPTION_ablation_racing = Option(
        "racing", SECTION_ablation, bool, False, ("ablation_racing", ),
        "Set a flag indicating whether racing should be used for ablation."
    )
    OPTION_ablation_clis_per_node = Option(
        "clis_per_node", SECTION_ablation, int, None,
        ("max_parallel_runs_per_node", "maximum_parallel_runs_per_node", ),
    ...
    OPTION_smac3_facade = Option(
        "facade", SECTION_smac3, str, "AlgorithmConfigurationFacade",
    ...
    OPTION_smac3_facade_max_ratio = Option(
        "facade_max_ratio", SECTION_smac3, float, None,
    ...
    OPTION_smac3_cpu_time_budget = Option(
        "cputime_limit", SECTION_smac3, float, None,
    ...
    OPTION_smac3_use_default_config = Option(
        "use_default_config", SECTION_smac3, bool, None, tuple(),
    ...
    OPTION_smac3_min_budget = Option(
        "min_budget", SECTION_smac3, float, None, ("minimum_budget", ),
    ...
    OPTION_smac3_max_budget = Option(
        "max_budget", SECTION_smac3, float, None, ("maximum_budget", ),
    ...
    OPTION_irace_max_iterations = Option(
        "max_iterations", SECTION_irace, int, None,
    ...
    OPTION_paramils_number_initial_configurations = Option(
        "initial_configurations", SECTION_paramils, int, None,
    ...
    OPTION_slurm_parallel_jobs = Option(
        "number_of_jobs_in_parallel", SECTION_slurm, int, None,
        ("num_job_in_parallel", ),
        "The number of jobs to run in parallel.")
    OPTION_slurm_prepend_script = Option(
        "prepend_script", SECTION_slurm, str, None,
        ("job_prepend", "prepend"),
    ...
    sections_options: dict[str, list[Option]] = {
        SECTION_general: [
            ...
            OPTION_extractor_cutoff_time, OPTION_run_on, OPTION_verbosity,
        ],
        SECTION_configuration: [OPTION_configurator_number_of_runs,
                                OPTION_configurator_solver_call_budget,
                                OPTION_configurator_max_iterations],
        SECTION_ablation: [OPTION_ablation_racing, OPTION_ablation_clis_per_node, ],
        SECTION_selection: [OPTION_selection_class, OPTION_selection_model],
        SECTION_smac2: [OPTION_smac2_wallclock_time_budget, OPTION_smac2_cpu_time_budget,
                        OPTION_smac2_target_cutoff_length, OPTION_smac2_count_tuner_time,
                        OPTION_smac2_cli_cores, OPTION_smac2_max_iterations],
        SECTION_smac3: [OPTION_smac3_number_of_trials, OPTION_smac3_facade,
                        OPTION_smac3_facade_max_ratio, OPTION_smac3_crash_cost,
                        OPTION_smac3_termination_cost_threshold,
                        OPTION_smac3_wallclock_time_budget, OPTION_smac3_cpu_time_budget,
                        OPTION_smac3_use_default_config, OPTION_smac3_min_budget,
                        OPTION_smac3_max_budget],
        SECTION_irace: [OPTION_irace_max_time, OPTION_irace_max_experiments,
                        OPTION_irace_first_test, OPTION_irace_mu,
                        OPTION_irace_max_iterations],
        SECTION_paramils: [OPTION_paramils_min_runs, OPTION_paramils_max_runs,
                           OPTION_paramils_cpu_time_budget,
                           OPTION_paramils_random_restart, OPTION_paramils_focused,
                           OPTION_paramils_count_tuner_time, OPTION_paramils_cli_cores,
    ...
    def __init__(self: Settings, file_path: Path,
                 argsv: argparse.Namespace = None) -> None:
            ...
            for option_name in file_settings.options(section):
                if option_name not in self.sections_options[section]:
                    if section == Settings.SECTION_slurm:  # Flexible section
                        self.__settings.set(section, option_name,
    ...
    def objectives(self: Settings) -> list[SparkleObjective]:
        ...
        if (self.__sparkle_objectives is None
            ...
            self.__sparkle_objectives = [resolve_objective(obj)
    ...
    def configurator(self: Settings) -> Configurator:
        ...
        if self.__general_sparkle_configurator is None and self.__settings.has_option(
            ...
            self.__general_sparkle_configurator =\
                cim.resolve_configurator(self.__settings.get(
                    Settings.OPTION_configurator.section,
                    Settings.OPTION_configurator.name))()
        ...
        if self.__verbosity_level is None:
            if self.__settings.has_option(
                ...
                self.__verbosity_level = VerbosityLevel[
                    self.__settings.get(Settings.OPTION_verbosity.section,
    ...
    def smac2_wallclock_time_budget(self: Settings) -> int:
        ...
        if self.__smac2_wallclock_time_budget is None:
            self.__smac2_wallclock_time_budget =\
                self._abstract_getter(Settings.OPTION_smac2_wallclock_time_budget)
    ...
    def smac2_cpu_time_budget(self: Settings) -> int:
        ...
        if self.__smac2_cpu_time_budget is None:
            self.__smac2_cpu_time_budget =\
                self._abstract_getter(Settings.OPTION_smac2_cpu_time_budget)
    ...
    def smac2_target_cutoff_length(self: Settings) -> str:
        ...
        if self.__smac2_target_cutoff_length is None:
            self.__smac2_target_cutoff_length =\
                self._abstract_getter(Settings.OPTION_smac2_target_cutoff_length)
    ...
    def smac2_use_tunertime_in_cpu_time_budget(self: Settings) -> bool:
        ...
        if self.__smac2_use_tunertime_in_cpu_time_budget is None:
            self.__smac2_use_tunertime_in_cpu_time_budget =\
                self._abstract_getter(Settings.OPTION_smac2_count_tuner_time)
    ...
    def smac2_cli_cores(self: Settings) -> int:
        ...
        if self.__smac2_cli_cores is None:
            self.__smac2_cli_cores =\
                self._abstract_getter(Settings.OPTION_smac2_cli_cores)
    ...
    def smac2_max_iterations(self: Settings) -> int:
        ...
        if self.__smac2_max_iterations is None:
            self.__smac2_max_iterations =\
                self._abstract_getter(Settings.OPTION_smac2_max_iterations)
    ...
    def smac3_number_of_trials(self: Settings) -> int:
        ...
        if self.__smac3_number_of_trials is None:
            self.__smac3_number_of_trials =\
                self._abstract_getter(Settings.OPTION_smac3_number_of_trials)
    ...
    def smac3_facade_max_ratio(self: Settings) -> float:
        ...
        if self.__smac3_facade_max_ratio is None:
            self.__smac3_facade_max_ratio =\
                self._abstract_getter(Settings.OPTION_smac3_facade_max_ratio)
    ...
    def smac3_crash_cost(self: Settings) -> float:
        ...
        if self.__smac3_crash_cost is None:
            self.__smac3_crash_cost =\
                self._abstract_getter(Settings.OPTION_smac3_crash_cost)
    ...
    def smac3_termination_cost_threshold(self: Settings) -> float:
        ...
        if self.__smac3_termination_cost_threshold is None:
            self.__smac3_termination_cost_threshold =\
                self._abstract_getter(Settings.OPTION_smac3_termination_cost_threshold)
    ...
    def smac3_wallclock_time_budget(self: Settings) -> int:
        ...
        if self.__smac3_wallclock_time_limit is None:
            self.__smac3_wallclock_time_limit =\
                self._abstract_getter(Settings.OPTION_smac3_wallclock_time_budget)
    ...
    def smac3_cpu_time_budget(self: Settings) -> int:
        ...
        if self.__smac3_cputime_limit is None:
            self.__smac3_cputime_limit =\
                self._abstract_getter(Settings.OPTION_smac3_cpu_time_budget)
    ...
    def smac3_use_default_config(self: Settings) -> bool:
        ...
        if self.__smac3_use_default_config is None:
            self.__smac3_use_default_config =\
                self._abstract_getter(Settings.OPTION_smac3_use_default_config)
    ...
    def smac3_min_budget(self: Settings) -> int:
        ...
        if self.__smac3_min_budget is None:
            self.__smac3_min_budget =\
                self._abstract_getter(Settings.OPTION_smac3_min_budget)
    ...
    def smac3_max_budget(self: Settings) -> int:
        ...
        if self.__smac3_max_budget is None:
            self.__smac3_max_budget =\
                self._abstract_getter(Settings.OPTION_smac3_max_budget)
    ...
    def irace_max_time(self: Settings) -> int:
        ...
        if self.__irace_max_time is None:
            self.__irace_max_time = self._abstract_getter(
                Settings.OPTION_irace_max_time)
    ...
    def get_configurator_settings(self: Settings,
        ...
        if configurator_name == cim.SMAC2.__name__:
            ...
            configurator_settings.update({
                ...
                self.smac3_termination_cost_threshold,
    ...
    @staticmethod
    def check_settings_changes(cur_settings: Settings, prev_settings: Settings,

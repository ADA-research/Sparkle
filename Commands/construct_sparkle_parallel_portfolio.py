...
if __name__ == r'__main__':
    ...
    parser.add_argument("--overwrite", default=sgh.settings.DEFAULT_parallel_portfolio_overwriting, action=ac.SetByUser, help='Allows overwriting of the directory, default true, when constructing a portfolio with a name of an already existing portfolio will throw an error if --overwrite False is used. Otherwise the previously constructed portfolio will be overwritten.')

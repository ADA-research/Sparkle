...
if __name__ == r"__main__":
    ...
    if not scsh.check_configuration_exists(solver_name, instance_set_train_name):
        print("c Error: No configuration results found for the given solver and training"
    ...
    if sah.check_for_ablation(
        ...
        print("c Warning: found existing ablation scenario for this combination. This "
              "will be removed.")

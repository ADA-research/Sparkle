...
if __name__ == r'__main__':
    ...
    parser.add_argument("--process-monitoring", choices=processMonitoring.__members__, default=sgh.settings.get_parallel_portfolio_process_monitoring(), action=ac.SetByUser, help='Specify wheneter the monitoring of the portfolio should cancel all solvers within a portfolio once a solver finishes(realistic), or allow all solvers within a portfolio to get an equal chance to have the lowest amount of running time on an instance(extended).')

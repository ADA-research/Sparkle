...
if __name__ == r"__main__":
    ...
    if use_features:
        ...
        for label, row in feature_data_df.iterrows():
            # os.path.split( os.path.split(label)[0] )[1] gives the folder/instance set name
        ...
        if feature_data_df.isnull().values.any():
            print("c you have unfinished feature computation jobs, please run compute_features.py")
            sys.exit()
    ...
    scsh.create_file_scenario_configuration(solver_name, instance_set_train_name, use_features)

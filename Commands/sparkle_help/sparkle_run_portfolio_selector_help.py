...
def call_solver_solve_instance_within_cutoff(solver_path, instance_path, cutoff_time):
	...
	srs.run_solver_on_instance(solver_path, solver_path+r'/'+sparkle_global_help.sparkle_run_default_wrapper, instance_path, raw_result_path, cutoff_time)
...
def call_sparkle_portfolio_selector_solve_instance(instance_path):
	...
	os.system('rm -f ' + sparkle_global_help.sparkle_log_path)

...
extractor_job_path = f"{sparkle_tmp_path}SBATCH_Extractor_Jobs/"
algorithm_selector_job_path = f"{sparkle_tmp_path}SBATCH_Portfolio_Jobs/"
report_job_path = f"{sparkle_tmp_path}SBATCH_Report_Jobs/"
configuration_job_path = f"{sparkle_tmp_path}SBATCH_Configuration_Jobs"

...
def validate_configured_vs_default(solver,instance_set_train,instance_set_test,configure_jobid=0,force=False):
	solver_name = sfh.get_last_level_directory_name(solver)
	instance_set_train_name = sfh.get_last_level_directory_name(instance_set_train)
	instance_set_test_name = sfh.get_last_level_directory_name(instance_set_test) #None
	...
	if instance_set_test is not None:
		...
		smac_inst_dir_prefix = sparkle_global_help.smac_dir + r'/' + 'example_scenarios/' + r'instances/' + sfh.get_last_level_directory_name(
			instances_directory_test)
	...
	sbatch_script_name = ssh.generate_sbatch_script_for_validation(solver_name, instance_set_train_name,
...
if __name__ == r'__main__':
	...
	validate_configured_vs_default(solver, instance_set_train, instance_set_test)